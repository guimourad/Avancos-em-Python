...
'''
Vamos pegar um exemplo de nível mínimo de estoque.
...
for i, lista in enumerate(estoque):
    #se dentro daquela lista em algum abaixo do nivel minimo
    for j, qtde in enumerate(lista):
        if qtde < nivel_minimo:
            if fabricas[i] in fabricaAbaixoNivel:
                pass
            else:
                fabricaAbaixoNivel.append(fabricas[i])

            print(f'Na {fabricas[i]} esta faltando o produto de indice {j}, com apenas {qtde} quantidades')
print(f'as fabricas com produtos com o nivel minimo sao: {fabricaAbaixoNivel}')
