...
for item in lista:
    if condicao:
        ...
        outra coisa
'''
#Digamos que a gente esteja analisando a meta de vendas de vários funcionários de uma empresa.
...
print(f'o percentual de pessoas que bateu a meta foi: {bateuMeta / funcionarios:.1%}')
