...
visto que algumas funções (tema dos próximos módulos) 
precisam de dicionários para funcionar e saber transformar listas em dicionários (e vice-versa)
...
for produto, (venda2019, venda2020) in vendasProdutos.items():
    print(f"'{produto}': ({venda2019}, {venda2020})")